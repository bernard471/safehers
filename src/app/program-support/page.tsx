...
const tiers = [
  ...
  },
  {
    ...
    features: [
      "All features of the Educator Certification",
      "Authorisation to conduct SafeHers certification workshops",
      "Commission structure for new educators trained",
      "Annual Master Trainer roundtable",
      "Quarterly curriculum review sessions",
    ],
    cta: "Apply as Master Trainer",
    ctaHref: "/contact",
    highlight: false,
  },
];
