...
export const metadata: Metadata = {
  title: "Media Kit — SafeHer Foundation",
  description:
    "SafeHer Foundation media kit: brand guidelines, press contacts, founder bios, and approved assets for journalists and media professionals.",
};
