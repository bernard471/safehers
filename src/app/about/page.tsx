    ...
    <>
      ...
      <section className="pt-40 pb-24 lg:pt-48">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          ...
          <h1 className="display text-[clamp(3rem,8vw,8rem)] font-light max-w-[1100px] mb-12">
            Two professionals.<br />
            <span className="display-italic text-burgundy">
              One movement.
            </span>
          </h1>
          <div className="grid lg:grid-cols-12 gap-12">
            <p className="lg:col-span-7 body-prose text-lg">
              SafeHers is a partnership between an American author with two
              decades of senior leadership in national security and privacy,
              and a Ghanaian cybersecurity expert with deep ground presence
              across West Africa. We met because the work demanded it.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="pb-32">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="grid md:grid-cols-2 gap-px bg-ink/15 border-y border-ink/15">
            ...
            >
              <p className="eyebrow mb-4">Co-Founder · Author</p>
              ...
              <p className="body-prose mb-4">
                CEO and Founder of Happy.Gov, Happy You, and Ballard & Silas
                LLCs. Author of 30 Ways Pretty Girls Can Save Themselves.
                Twenty-plus years as a senior leader in national security,
                privacy, law, and international trade.
              </p>
              <p className="body-prose mb-6">
                A proud HBCU, law, and Harvard Kennedy School graduate, with
                additional certifications in counterterrorism, use of force,
                European Union law, and commercial real estate. Has been
                teaching this material to teen girls and women since 2015.
              </p>
            ...
            <motion.div
              ...
              className="bg-cream p-8 sm:p-10 lg:p-16"
            >
              <p className="eyebrow mb-4">Co-founder · Cybersecurity</p>
              <h2 className="display text-5xl mb-2">David</h2>
              <p className="display-italic text-5xl text-burgundy mb-8">
                Gyedu
              </p>
              <p className="body-prose mb-4">
                Founder of DK Cyber. Cybersecurity expert based in Accra,
                Ghana, with technical depth in account security, mobile
                fraud, social engineering, and digital safety architecture
                for African contexts.
              </p>
              <p className="body-prose mb-6">
                Brings the on-the-ground operational capacity, cultural
                fluency, and African network that turns SafeHers from
                imported curriculum into authentic local movement. Leads
                technology, regional operations, and government engagement
      ...
      <section className="py-32 bg-bone">
        <div className="max-w-[1100px] mx-auto px-6 lg:px-12">
          <p className="eyebrow mb-8 text-center">Our story</p>
          ...
          <div className="space-y-8 body-prose text-lg max-w-3xl mx-auto">
            ...
            <p>
              ...
              tools for African digital life and recognized the framework
              as the missing curriculum piece he needed.
            </p>
            <p>
              SafeHers is the result. An American framework, an African
              edition, a partnership that combines twenty years of
              security expertise with cultural fluency that no amount of
              translation can replicate. Built for women everywhere.
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="grid lg:grid-cols-12 gap-12 mb-16">
            ...
            <p className="lg:col-span-6 lg:col-start-7 body-prose lg:pt-8">
              Five principles that shape every decision we make — what we
              build, what we charge, who we partner with, and what we
              refuse to do.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-ink/15">
            {[
              ...
              {
                num: "02",
                title: "Localize, don't translate",
              ...
              },
              {
                ...
                desc: "Free programs that collapse after one grant cycle help nobody. We build to last.",
              },
              {
                num: "04",
                title: "Impact and revenue align",
                desc: "The most-funded programs are the ones that show measurable results. We measure.",
              },
              {
                num: "05",
              ...
              >
                <p className="num-tag text-4xl text-burgundy mb-4">{v.num}</p>
      ...
      <section className="py-32 bg-ink text-cream">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12 grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            <p className="eyebrow mb-6 text-rose">Join us</p>
            <h2 className="display text-5xl lg:text-7xl">
              The work is<br />
              <span className="display-italic text-rose">just beginning.</span>
            </h2>
          </div>
          <div className="lg:col-span-4 lg:col-start-9">
            <p className="body-prose opacity-80 mb-6">
              If you serve women and girls — as a school, a company, a
              government, or a funder — we want to hear from you.
            </p>
            <Link
              href="/contact"
              className="inline-flex items-center gap-3 bg-cream text-ink px-7 py-4 hover:bg-rose transition-colors group"
            >
