"use strict";(()=>{var e={};e.id=4176,e.ids=[4176],e.modules={11185:e=>{e.exports=require("mongoose")},72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},27790:e=>{e.exports=require("assert")},78893:e=>{e.exports=require("buffer")},84770:e=>{e.exports=require("crypto")},17702:e=>{e.exports=require("events")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},86624:e=>{e.exports=require("querystring")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},6005:e=>{e.exports=require("node:crypto")},53037:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>b,patchFetch:()=>w,requestAsyncStorage:()=>x,routeModule:()=>y,serverHooks:()=>E,staticGenerationAsyncStorage:()=>h});var i={};o.r(i),o.d(i,{POST:()=>g});var r=o(49303),n=o(88716),a=o(60670),s=o(87070),l=o(82591),p=o(14184),c=o(4493),d=o(37604),u=o(57662),f=o(90477);let m=process.env.RESEND_API_KEY?new l.R(process.env.RESEND_API_KEY):null;async function g(e){try{let t=await (0,d.MH)("admin","super_admin");if(!t.authorized)return t.response;let{cohortId:o,emails:i}=await e.json();if(!o||!i?.length)return s.NextResponse.json({error:"Cohort ID and email list required."},{status:400});await (0,p.u)();let r=await c.w.findById(o).populate("course","title");if(!r)return s.NextResponse.json({error:"Cohort not found."},{status:404});let n=r.course?.title||"SafeHer Academy Course",a=0;if(m)for(let e of i){let t=e.trim().toLowerCase();if(t)try{await m.emails.send({from:"SafeHer Foundation <noreply@safehers.africa>",to:t,subject:`You're invited to ${r.name} — SafeHer Academy`,html:(0,f.Bf)(t.split("@")[0],r.name,n)}),a++}catch(e){console.error(`[cohort/invite] Failed to send to ${t}:`,e)}}return await (0,u.A)({userId:t.session.user.id,userEmail:t.session.user.email,action:"invite_to_cohort",resource:"Cohort",resourceId:o,details:`Invited ${a} of ${i.length} emails to "${r.name}"`}),s.NextResponse.json({ok:!0,sent:a,total:i.length})}catch(e){return console.error("[admin/cohorts/invite]",e),s.NextResponse.json({error:"Invite failed."},{status:500})}}let y=new r.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/admin/academy/cohorts/invite/route",pathname:"/api/admin/academy/cohorts/invite",filename:"route",bundlePath:"app/api/admin/academy/cohorts/invite/route"},resolvedPagePath:"/opt/safeher/safehers/src/app/api/admin/academy/cohorts/invite/route.ts",nextConfigOutput:"",userland:i}),{requestAsyncStorage:x,staticGenerationAsyncStorage:h,serverHooks:E}=y,b="/api/admin/academy/cohorts/invite/route";function w(){return(0,a.patchFetch)({serverHooks:E,staticGenerationAsyncStorage:h})}},57662:(e,t,o)=>{o.d(t,{A:()=>l});var i=o(14184),r=o(11185),n=o.n(r);let a=new r.Schema({userId:{type:String,required:!0},userEmail:{type:String},action:{type:String,required:!0},resource:{type:String,required:!0},resourceId:{type:String},details:{type:String},ip:{type:String},timestamp:{type:Date,default:Date.now}}),s=r.models.AuditLog||n().model("AuditLog",a);async function l(e){try{await (0,i.u)(),await s.create(e)}catch(e){console.error("[audit] Failed to log:",e)}}},95456:(e,t,o)=>{o.d(t,{L:()=>s});var i=o(53797),r=o(98691),n=o(14184),a=o(93330);let s={providers:[(0,i.Z)({id:"admin-login",name:"Admin Credentials",credentials:{email:{label:"Email",type:"email"},password:{label:"Password",type:"password"}},async authorize(e){let t=process.env.ADMIN_EMAIL,o=process.env.ADMIN_PASSWORD;return t&&o&&e?.email===t&&e?.password===o?{id:"admin-1",email:t,name:"SafeHer Admin",role:"super_admin"}:null}}),(0,i.Z)({id:"portal-login",name:"Portal Login",credentials:{email:{label:"Email",type:"email"},password:{label:"Password",type:"password"}},async authorize(e){if(!e?.email||!e?.password)return null;try{await (0,n.u)();let t=await a.n.findOne({email:e.email.toLowerCase(),isActive:!0});if(!t||!await r.ZP.compare(e.password,t.passwordHash))return null;return await a.n.updateOne({_id:t._id},{lastLoginAt:new Date}),{id:t._id.toString(),email:t.email,name:t.name,role:t.role}}catch{return null}}})],callbacks:{jwt:async({token:e,user:t})=>(t&&(e.role=t.role??"beneficiary",e.userId=t.id),e),session:async({session:e,token:t})=>(e.user&&(e.user.role=t.role,e.user.id=t.userId),e)},session:{strategy:"jwt",maxAge:86400},pages:{signIn:"/admin/login"},secret:process.env.NEXTAUTH_SECRET}},90477:(e,t,o)=>{o.d(t,{Bf:()=>y,EC:()=>u,M5:()=>p,Mu:()=>m,PF:()=>f,Py:()=>s,Z3:()=>g,al:()=>n,bG:()=>a,lx:()=>c,oe:()=>l,t2:()=>d});let i=process.env.NEXTAUTH_URL??"https://safehers.africa";function r(e){return`
    <!DOCTYPE html>
    <html lang="en">
    <head>
      <meta charset="UTF-8" />
