"use strict";(()=>{var e={};e.id=9787,e.ids=[9787],e.modules={11185:e=>{e.exports=require("mongoose")},72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},27790:e=>{e.exports=require("assert")},78893:e=>{e.exports=require("buffer")},84770:e=>{e.exports=require("crypto")},17702:e=>{e.exports=require("events")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},86624:e=>{e.exports=require("querystring")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},6005:e=>{e.exports=require("node:crypto")},17069:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>z,patchFetch:()=>F,requestAsyncStorage:()=>w,routeModule:()=>E,serverHooks:()=>v,staticGenerationAsyncStorage:()=>b});var i={};o.r(i),o.d(i,{POST:()=>x,PUT:()=>h});var r=o(49303),n=o(88716),a=o(60670),s=o(87070),p=o(84770),l=o.n(p),c=o(82591),d=o(14184),u=o(91099),f=o(37604),m=o(57662),g=o(90477);let y=process.env.RESEND_API_KEY?new c.R(process.env.RESEND_API_KEY):null;async function x(){try{let e=await (0,f.MH)("admin","super_admin");if(!e.authorized)return e.response;let t=l().randomInt(1e5,999999).toString();return await (0,d.u)(),await u.W.updateMany({userId:e.session.user.id,type:"admin_otp",used:!1},{used:!0}),await u.W.create({userId:e.session.user.id,type:"admin_otp",token:t,expiresAt:new Date(Date.now()+6e5)}),await (0,m.A)({userId:e.session.user.id,userEmail:e.session.user.email,action:"admin_otp_requested",resource:"AdminAuth"}),y&&e.session.user.email&&await y.emails.send({from:"SafeHer Foundation <noreply@safehers.africa>",to:e.session.user.email,subject:"Admin verification code — SafeHer Foundation",html:(0,g.M5)(t)}),s.NextResponse.json({ok:!0})}catch(e){return console.error("[admin/otp]",e),s.NextResponse.json({error:"Failed."},{status:500})}}async function h(e){try{let t=await (0,f.MH)("admin","super_admin");if(!t.authorized)return t.response;let{otp:o}=await e.json();if(!o)return s.NextResponse.json({error:"OTP required."},{status:400});await (0,d.u)();let i=await u.W.findOne({userId:t.session.user.id,type:"admin_otp",token:o,used:!1,expiresAt:{$gt:new Date}});if(!i)return await (0,m.A)({userId:t.session.user.id,userEmail:t.session.user.email,action:"admin_otp_failed",resource:"AdminAuth",details:"Invalid or expired OTP attempt"}),s.NextResponse.json({error:"Invalid or expired code."},{status:400});return await u.W.updateOne({_id:i._id},{used:!0}),await (0,m.A)({userId:t.session.user.id,userEmail:t.session.user.email,action:"admin_otp_verified",resource:"AdminAuth"}),s.NextResponse.json({ok:!0,verified:!0})}catch(e){return console.error("[admin/otp/verify]",e),s.NextResponse.json({error:"Verification failed."},{status:500})}}let E=new r.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/admin/otp/route",pathname:"/api/admin/otp",filename:"route",bundlePath:"app/api/admin/otp/route"},resolvedPagePath:"/opt/safeher/safehers/src/app/api/admin/otp/route.ts",nextConfigOutput:"",userland:i}),{requestAsyncStorage:w,staticGenerationAsyncStorage:b,serverHooks:v}=E,z="/api/admin/otp/route";function F(){return(0,a.patchFetch)({serverHooks:v,staticGenerationAsyncStorage:b})}},57662:(e,t,o)=>{o.d(t,{A:()=>p});var i=o(14184),r=o(11185),n=o.n(r);let a=new r.Schema({userId:{type:String,required:!0},userEmail:{type:String},action:{type:String,required:!0},resource:{type:String,required:!0},resourceId:{type:String},details:{type:String},ip:{type:String},timestamp:{type:Date,default:Date.now}}),s=r.models.AuditLog||n().model("AuditLog",a);async function p(e){try{await (0,i.u)(),await s.create(e)}catch(e){console.error("[audit] Failed to log:",e)}}},95456:(e,t,o)=>{o.d(t,{L:()=>s});var i=o(53797),r=o(98691),n=o(14184),a=o(93330);let s={providers:[(0,i.Z)({id:"admin-login",name:"Admin Credentials",credentials:{email:{label:"Email",type:"email"},password:{label:"Password",type:"password"}},async authorize(e){let t=process.env.ADMIN_EMAIL,o=process.env.ADMIN_PASSWORD;return t&&o&&e?.email===t&&e?.password===o?{id:"admin-1",email:t,name:"SafeHer Admin",role:"super_admin"}:null}}),(0,i.Z)({id:"portal-login",name:"Portal Login",credentials:{email:{label:"Email",type:"email"},password:{label:"Password",type:"password"}},async authorize(e){if(!e?.email||!e?.password)return null;try{await (0,n.u)();let t=await a.n.findOne({email:e.email.toLowerCase(),isActive:!0});if(!t||!await r.ZP.compare(e.password,t.passwordHash))return null;return await a.n.updateOne({_id:t._id},{lastLoginAt:new Date}),{id:t._id.toString(),email:t.email,name:t.name,role:t.role}}catch{return null}}})],callbacks:{jwt:async({token:e,user:t})=>(t&&(e.role=t.role??"beneficiary",e.userId=t.id),e),session:async({session:e,token:t})=>(e.user&&(e.user.role=t.role,e.user.id=t.userId),e)},session:{strategy:"jwt",maxAge:86400},pages:{signIn:"/admin/login"},secret:process.env.NEXTAUTH_SECRET}},90477:(e,t,o)=>{o.d(t,{Bf:()=>y,EC:()=>u,M5:()=>l,Mu:()=>m,PF:()=>f,Py:()=>s,Z3:()=>g,al:()=>n,bG:()=>a,lx:()=>c,oe:()=>p,t2:()=>d});let i=process.env.NEXTAUTH_URL??"https://safehers.africa";function r(e){return`
    <!DOCTYPE html>
    <html lang="en">
    <head>
      <meta charset="UTF-8" />
