"use strict";(()=>{var e={};e.id=2755,e.ids=[2755],e.modules={11185:e=>{e.exports=require("mongoose")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},84770:e=>{e.exports=require("crypto")},6005:e=>{e.exports=require("node:crypto")},6736:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>z,patchFetch:()=>v,requestAsyncStorage:()=>w,routeModule:()=>E,serverHooks:()=>F,staticGenerationAsyncStorage:()=>b});var i={};o.r(i),o.d(i,{POST:()=>h});var n=o(49303),r=o(88716),a=o(60670),s=o(87070),p=o(82591),l=o(84770),c=o.n(l),f=o(14184),d=o(93330),u=o(91099),m=o(55091),g=o(90477);let y=process.env.RESEND_API_KEY?new p.R(process.env.RESEND_API_KEY):null,x=process.env.NEXTAUTH_URL??"https://safehers.africa";async function h(e){try{let t=e.headers.get("x-forwarded-for")?.split(",")[0]?.trim()??"unknown";if(!await (0,m.D)(t,"auth"))return s.NextResponse.json({error:"Too many requests."},{status:429});let{email:o}=await e.json();if(!o)return s.NextResponse.json({error:"Email required."},{status:400});await (0,f.u)();let i=await d.n.findOne({email:o.toLowerCase(),isActive:!0});if(!i)return s.NextResponse.json({ok:!0});let n=c().randomBytes(32).toString("hex");if(await u.W.create({userId:i._id,type:"password_reset",token:n,expiresAt:new Date(Date.now()+36e5)}),y){let e=`${x}/portal/reset-password?token=${n}`;await y.emails.send({from:"SafeHer Foundation <noreply@safehers.africa>",to:i.email,subject:"Reset your password — SafeHer Academy",html:(0,g.oe)(i.name,e)})}return s.NextResponse.json({ok:!0})}catch(e){return console.error("[forgot-password]",e),s.NextResponse.json({error:"Failed."},{status:500})}}let E=new n.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/portal/forgot-password/route",pathname:"/api/portal/forgot-password",filename:"route",bundlePath:"app/api/portal/forgot-password/route"},resolvedPagePath:"/opt/safeher/safehers/src/app/api/portal/forgot-password/route.ts",nextConfigOutput:"",userland:i}),{requestAsyncStorage:w,staticGenerationAsyncStorage:b,serverHooks:F}=E,z="/api/portal/forgot-password/route";function v(){return(0,a.patchFetch)({serverHooks:F,staticGenerationAsyncStorage:b})}},90477:(e,t,o)=>{o.d(t,{Bf:()=>y,EC:()=>d,M5:()=>l,Mu:()=>m,PF:()=>u,Py:()=>s,Z3:()=>g,al:()=>r,bG:()=>a,lx:()=>c,oe:()=>p,t2:()=>f});let i=process.env.NEXTAUTH_URL??"https://safehers.africa";function n(e){return`
    <!DOCTYPE html>
    <html lang="en">
    <head>
      <meta charset="UTF-8" />
  ...
  `)}},14184:(e,t,o)=>{o.d(t,{u:()=>s});var i=o(11185),n=o.n(i);let r=process.env.MONGODB_URI;r||console.warn("[mongo] MONGODB_URI not set. API routes that need a database will fail. Copy .env.local.example to .env.local and set MONGODB_URI.");let a=global.mongoose??{conn:null,promise:null};async function s(){if(a.conn)return a.conn;if(!r)throw Error("MONGODB_URI not configured");return a.promise||(a.promise=n().connect(r,{bufferCommands:!1}).then(e=>e)),a.conn=await a.promise,a.conn}global.mongoose||(global.mongoose=a)},55091:(e,t,o)=>{o.d(t,{D:()=>c});var i=o(11185),n=o.n(i),r=o(14184);let a=new i.Schema({key:{type:String,required:!0,index:!0},count:{type:Number,default:1},resetAt:{type:Date,required:!0,index:{expires:0}}}),s=i.models.RateLimitEntry||n().model("RateLimitEntry",a),p={default:{max:5,windowMs:36e5},auth:{max:10,windowMs:9e5},register:{max:3,windowMs:36e5},verify:{max:20,windowMs:36e5}},l=new Map;async function c(e,t="default"){let o=p[t]||p.default,i=`${t}:${e}`,n=Date.now();try{await (0,r.u)();let e=await s.findOne({key:i});if(!e||new Date(e.resetAt).getTime()<n)return await s.findOneAndUpdate({key:i},{key:i,count:1,resetAt:new Date(n+o.windowMs)},{upsert:!0}),!0;if(e.count>=o.max)return!1;return await s.updateOne({key:i},{$inc:{count:1}}),!0}catch{let e=l.get(i);if(!e||n>e.resetAt)return l.set(i,{count:1,resetAt:n+o.windowMs}),!0;if(e.count>=o.max)return!1;return e.count++,!0}}},91099:(e,t,o)=>{o.d(t,{W:()=>a});var i=o(11185),n=o.n(i);let r=new i.Schema({userId:{type:i.Schema.Types.ObjectId,ref:"User",required:!0},type:{type:String,enum:["email_verification","password_reset","admin_otp"],required:!0},token:{type:String,required:!0,unique:!0},expiresAt:{type:Date,required:!0,index:{expires:0}},used:{type:Boolean,default:!1},createdAt:{type:Date,default:Date.now}}),a=i.models.Token||n().model("Token",r)},93330:(e,t,o)=>{o.d(t,{n:()=>a});var i=o(11185),n=o.n(i);let r=new i.Schema({email:{type:String,required:!0,unique:!0,lowercase:!0,trim:!0},passwordHash:{type:String,required:!0},name:{type:String,required:!0,trim:!0},role:{type:String,enum:["beneficiary","educator","consultant","institution_admin","donor","admin","super_admin"],default:"beneficiary"},phone:{type:String,trim:!0},country:{type:String,default:"Ghana"},dateOfBirth:{type:Date},isMinor:{type:Boolean,default:!1},guardianName:{type:String,trim:!0},guardianEmail:{type:String,trim:!0},guardianConsent:{type:Boolean,default:!1},institution:{type:i.Schema.Types.ObjectId,ref:"Institution"},cohort:{type:i.Schema.Types.ObjectId,ref:"Cohort"},bio:{type:String,maxlength:500},avatarUrl:{type:String},isActive:{type:Boolean,default:!0},emailVerified:{type:Boolean,default:!1},lastLoginAt:{type:Date}},{timestamps:!0}),a=i.models.User||n().model("User",r)}};var t=require("../../../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),i=t.X(0,[8948,5972,2591],()=>o(6736));module.exports=i})();