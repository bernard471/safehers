"use strict";(()=>{var e={};e.id=5498,e.ids=[5498],e.modules={11185:e=>{e.exports=require("mongoose")},72934:e=>{e.exports=require("next/dist/client/components/action-async-storage.external.js")},54580:e=>{e.exports=require("next/dist/client/components/request-async-storage.external.js")},45869:e=>{e.exports=require("next/dist/client/components/static-generation-async-storage.external.js")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},27790:e=>{e.exports=require("assert")},78893:e=>{e.exports=require("buffer")},84770:e=>{e.exports=require("crypto")},17702:e=>{e.exports=require("events")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},86624:e=>{e.exports=require("querystring")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},6005:e=>{e.exports=require("node:crypto")},66562:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>b,patchFetch:()=>z,requestAsyncStorage:()=>h,routeModule:()=>x,serverHooks:()=>w,staticGenerationAsyncStorage:()=>E});var n={};o.r(n),o.d(n,{GET:()=>g,POST:()=>y});var r=o(49303),i=o(88716),a=o(60670),s=o(87070),l=o(82591),p=o(14184),c=o(95931),d=o(37604),u=o(55091),f=o(90477);let m=process.env.RESEND_API_KEY?new l.R(process.env.RESEND_API_KEY):null;async function g(){try{let e=await (0,d.mk)();if(!e.authorized)return e.response;await (0,p.u)();let t=await c.h.find({user:e.session.user.id}).select("type format preferredDate status urgency createdAt confirmedDate").sort({createdAt:-1}).lean();return s.NextResponse.json({consultations:t})}catch{return s.NextResponse.json({consultations:[]})}}async function y(e){try{let t=e.headers.get("x-forwarded-for")?.split(",")[0]?.trim()??"unknown";if(!await (0,u.D)(t))return s.NextResponse.json({error:"Too many requests."},{status:429});let o=await (0,d.mk)();if(!o.authorized)return o.response;let{type:n,format:r,preferredDate:i,preferredTime:a,description:l,urgency:g}=await e.json();if(!n||!i||!l)return s.NextResponse.json({error:"Type, date and description are required."},{status:400});if(l.length>1e3)return s.NextResponse.json({error:"Description too long (max 1000 characters)."},{status:400});if(await (0,p.u)(),await c.h.create({user:o.session.user.id,type:n,format:r||"virtual",preferredDate:new Date(i),preferredTime:a,description:l,urgency:g||"standard"}),m&&o.session.user.email){let e=new Date(i).toLocaleDateString("en-GB",{day:"numeric",month:"long",year:"numeric"});m.emails.send({from:"SafeHer Foundation <noreply@safehers.africa>",to:o.session.user.email,subject:"Consultation request received — SafeHer Foundation",html:(0,f.Z3)(o.session.user.name,n,e)}).catch(e=>console.error("[consultation] Email failed:",e))}return s.NextResponse.json({ok:!0},{status:201})}catch(e){return console.error("[portal/consultations]",e),s.NextResponse.json({error:"Booking failed."},{status:500})}}let x=new r.AppRouteRouteModule({definition:{kind:i.x.APP_ROUTE,page:"/api/portal/consultations/route",pathname:"/api/portal/consultations",filename:"route",bundlePath:"app/api/portal/consultations/route"},resolvedPagePath:"/opt/safeher/safehers/src/app/api/portal/consultations/route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:h,staticGenerationAsyncStorage:E,serverHooks:w}=x,b="/api/portal/consultations/route";function z(){return(0,a.patchFetch)({serverHooks:w,staticGenerationAsyncStorage:E})}},95456:(e,t,o)=>{o.d(t,{L:()=>s});var n=o(53797),r=o(98691),i=o(14184),a=o(93330);let s={providers:[(0,n.Z)({id:"admin-login",name:"Admin Credentials",credentials:{email:{label:"Email",type:"email"},password:{label:"Password",type:"password"}},async authorize(e){let t=process.env.ADMIN_EMAIL,o=process.env.ADMIN_PASSWORD;return t&&o&&e?.email===t&&e?.password===o?{id:"admin-1",email:t,name:"SafeHer Admin",role:"super_admin"}:null}}),(0,n.Z)({id:"portal-login",name:"Portal Login",credentials:{email:{label:"Email",type:"email"},password:{label:"Password",type:"password"}},async authorize(e){if(!e?.email||!e?.password)return null;try{await (0,i.u)();let t=await a.n.findOne({email:e.email.toLowerCase(),isActive:!0});if(!t||!await r.ZP.compare(e.password,t.passwordHash))return null;return await a.n.updateOne({_id:t._id},{lastLoginAt:new Date}),{id:t._id.toString(),email:t.email,name:t.name,role:t.role}}catch{return null}}})],callbacks:{jwt:async({token:e,user:t})=>(t&&(e.role=t.role??"beneficiary",e.userId=t.id),e),session:async({session:e,token:t})=>(e.user&&(e.user.role=t.role,e.user.id=t.userId),e)},session:{strategy:"jwt",maxAge:86400},pages:{signIn:"/admin/login"},secret:process.env.NEXTAUTH_SECRET}},90477:(e,t,o)=>{o.d(t,{Bf:()=>y,EC:()=>u,M5:()=>p,Mu:()=>m,PF:()=>f,Py:()=>s,Z3:()=>g,al:()=>i,bG:()=>a,lx:()=>c,oe:()=>l,t2:()=>d});let n=process.env.NEXTAUTH_URL??"https://safehers.africa";function r(e){return`
    <!DOCTYPE html>
    <html lang="en">
    <head>
      <meta charset="UTF-8" />
  ...
  `)}},14184:(e,t,o)=>{o.d(t,{u:()=>s});var n=o(11185),r=o.n(n);let i=process.env.MONGODB_URI;i||console.warn("[mongo] MONGODB_URI not set. API routes that need a database will fail. Copy .env.local.example to .env.local and set MONGODB_URI.");let a=global.mongoose??{conn:null,promise:null};async function s(){if(a.conn)return a.conn;if(!i)throw Error("MONGODB_URI not configured");return a.promise||(a.promise=r().connect(i,{bufferCommands:!1}).then(e=>e)),a.conn=await a.promise,a.conn}global.mongoose||(global.mongoose=a)},55091:(e,t,o)=>{o.d(t,{D:()=>c});var n=o(11185),r=o.n(n),i=o(14184);let a=new n.Schema({key:{type:String,required:!0,index:!0},count:{type:Number,default:1},resetAt:{type:Date,required:!0,index:{expires:0}}}),s=n.models.RateLimitEntry||r().model("RateLimitEntry",a),l={default:{max:5,windowMs:36e5},auth:{max:10,windowMs:9e5},register:{max:3,windowMs:36e5},verify:{max:20,windowMs:36e5}},p=new Map;async function c(e,t="default"){let o=l[t]||l.default,n=`${t}:${e}`,r=Date.now();try{await (0,i.u)();let e=await s.findOne({key:n});if(!e||new Date(e.resetAt).getTime()<r)return await s.findOneAndUpdate({key:n},{key:n,count:1,resetAt:new Date(r+o.windowMs)},{upsert:!0}),!0;if(e.count>=o.max)return!1;return await s.updateOne({key:n},{$inc:{count:1}}),!0}catch{let e=p.get(n);if(!e||r>e.resetAt)return p.set(n,{count:1,resetAt:r+o.windowMs}),!0;if(e.count>=o.max)return!1;return e.count++,!0}}},37604:(e,t,o)=>{o.d(t,{MH:()=>a,mk:()=>s});var n=o(75571),r=o(87070),i=o(95456);async function a(...e){let t=await (0,n.getServerSession)(i.L);if(!t?.user?.id)return{authorized:!1,session:null,response:r.NextResponse.json({error:"Authentication required."},{status:401})};let o=t.user.role;return o&&e.includes(o)?{authorized:!0,session:t}:{authorized:!1,session:null,response:r.NextResponse.json({error:"Insufficient permissions."},{status:403})}}async function s(){let e=await (0,n.getServerSession)(i.L);return e?.user?.id?{authorized:!0,session:e}:{authorized:!1,session:null,response:r.NextResponse.json({error:"Authentication required."},{status:401})}}},95931:(e,t,o)=>{o.d(t,{h:()=>a});var n=o(11185),r=o.n(n);let i=new n.Schema({user:{type:n.Schema.Types.ObjectId,ref:"User",required:!0},type:{type:String,enum:["personal-safety","online-safety","financial-safety","sextortion-response","campus-safety","general"],required:!0},format:{type:String,enum:["virtual","in-person"],default:"virtual"},preferredDate:{type:Date,required:!0},preferredTime:{type:String},description:{type:String,required:!0,maxlength:1e3},urgency:{type:String,enum:["standard","urgent"],default:"standard"},status:{type:String,enum:["pending","confirmed","completed","cancelled"],default:"pending"},assignedTo:{type:n.Schema.Types.ObjectId,ref:"User"},consultantNotes:{type:String},location:{type:String},meetingLink:{type:String},confirmedDate:{type:Date}},{timestamps:!0}),a=n.models.Consultation||r().model("Consultation",i)},93330:(e,t,o)=>{o.d(t,{n:()=>a});var n=o(11185),r=o.n(n);let i=new n.Schema({email:{type:String,required:!0,unique:!0,lowercase:!0,trim:!0},passwordHash:{type:String,required:!0},name:{type:String,required:!0,trim:!0},role:{type:String,enum:["beneficiary","educator","consultant","institution_admin","donor","admin","super_admin"],default:"beneficiary"},phone:{type:String,trim:!0},country:{type:String,default:"Ghana"},dateOfBirth:{type:Date},isMinor:{type:Boolean,default:!1},guardianName:{type:String,trim:!0},guardianEmail:{type:String,trim:!0},guardianConsent:{type:Boolean,default:!1},institution:{type:n.Schema.Types.ObjectId,ref:"Institution"},cohort:{type:n.Schema.Types.ObjectId,ref:"Cohort"},bio:{type:String,maxlength:500},avatarUrl:{type:String},isActive:{type:Boolean,default:!0},emailVerified:{type:Boolean,default:!1},lastLoginAt:{type:Date}},{timestamps:!0}),a=n.models.User||r().model("User",i)}};var t=require("../../../../webpack-runtime.js");t.C(e);var o=e=>t(t.s=e),n=t.X(0,[8948,5972,8691,1790,2591],()=>o(66562));module.exports=n})();