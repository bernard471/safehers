"use strict";(()=>{var e={};e.id=5497,e.ids=[5497],e.modules={11185:e=>{e.exports=require("mongoose")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6005:e=>{e.exports=require("node:crypto")},72076:(e,t,o)=>{o.r(t),o.d(t,{originalPathname:()=>E,patchFetch:()=>w,requestAsyncStorage:()=>y,routeModule:()=>g,serverHooks:()=>h,staticGenerationAsyncStorage:()=>x});var n={};o.r(n),o.d(n,{POST:()=>u});var i=o(49303),r=o(88716),a=o(60670),s=o(87070),p=o(82591),l=o(14184),c=o(61021),f=o(55091),d=o(90477);let m=process.env.RESEND_API_KEY?new p.R(process.env.RESEND_API_KEY):null;async function u(e){try{let{email:t,website:o}=await e.json();if(o)return s.NextResponse.json({ok:!0},{status:200});let n=e.headers.get("x-forwarded-for")?.split(",")[0]?.trim()??"unknown";if(!await (0,f.D)(n))return s.NextResponse.json({error:"Too many requests. Please try again later."},{status:429});if(!t||!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t))return s.NextResponse.json({error:"Please provide a valid email."},{status:400});let i=!1;try{await (0,l.u)();let e=await c.m.findOneAndUpdate({email:t},{email:t},{upsert:!0,new:!0,setDefaultsOnInsert:!0});i=!!(e.createdAt&&e.updatedAt&&e.createdAt.getTime()===e.updatedAt.getTime())}catch(e){console.error("[newsletter] DB error:",e),i=!0}return m&&i&&m.emails.send({from:"SafeHer Foundation <hello@safehers.africa>",to:t,subject:"Welcome to SafeHer Foundation",html:(0,d.lx)(t)}).catch(e=>console.error("[newsletter] Email failed:",e)),s.NextResponse.json({ok:!0},{status:200})}catch(e){return console.error("[newsletter] error:",e),s.NextResponse.json({error:"Server error."},{status:500})}}let g=new i.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/newsletter/route",pathname:"/api/newsletter",filename:"route",bundlePath:"app/api/newsletter/route"},resolvedPagePath:"/opt/safeher/safehers/src/app/api/newsletter/route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:y,staticGenerationAsyncStorage:x,serverHooks:h}=g,E="/api/newsletter/route";function w(){return(0,a.patchFetch)({serverHooks:h,staticGenerationAsyncStorage:x})}},90477:(e,t,o)=>{o.d(t,{Bf:()=>y,EC:()=>d,M5:()=>l,Mu:()=>u,PF:()=>m,Py:()=>s,Z3:()=>g,al:()=>r,bG:()=>a,lx:()=>c,oe:()=>p,t2:()=>f});let n=process.env.NEXTAUTH_URL??"https://safehers.africa";function i(e){return`
    <!DOCTYPE html>
    <html lang="en">
    <head>
      <meta charset="UTF-8" />
